    ...
    static async actualizarPerfil(id_usuario, datosActualizacion) {
        try {
            ...
            const result = await query(
                ...
                RETURNING id_usuario, email, nombre_usuario, nombre_completo, telefono, fecha_nacimiento, sexo, fecha_creacion, fecha_ultima_actividad, email_verificado, es_premium`,
                valores
            );
        ...
        try {
            const result = await query(
                `SELECT id_usuario, email, nombre_usuario, nombre_completo, telefono, 
                        fecha_nacimiento, sexo, fecha_creacion, fecha_ultima_actividad, 
